...
public class Frozen_Fridge_Item {
    int food_img;
    String food_name;
    String food_count;
    String food_date;

    public Frozen_Fridge_Item(int food_img, String food_name, String food_count, String food_date) {
    ...
    public Frozen_Fridge_Item(int food_img, String food_name, String food_count)
    {
        this.food_img = food_img;
        this.food_name = food_name;
        this.food_count=food_count;
